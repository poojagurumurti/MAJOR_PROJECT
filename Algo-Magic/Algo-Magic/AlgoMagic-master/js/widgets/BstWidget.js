...
var BST = function () {
  ...
  function dummyInit() {
    ...
    for (key in internalBst) {
      ...
      graphWidget.addVertex(
        ...
        currentVertex["cy"],
        key,
        currentVertex["vertexClassNumber"],
        true
      );
    }
  ...
  this.search = function (vertexText) {
    ...
    while (currentVertex != vertexText && currentVertex != null) {
      ...
      currentState["status"] =
        "Comparing " + currentVertex + " with " + vertexText;
      ...
      if (parseInt(vertexText) > parseInt(currentVertex)) {
        currentState = createState(internalBst, vertexTraversed, edgeTraversed);
        currentState["status"] =
          currentVertex + " is smaller than " + vertexText;
        ...
        currentState = createState(internalBst, vertexTraversed, edgeTraversed);
        currentState["status"] =
          currentVertex + " is greater than " + vertexText;
    ...
    currentState["status"] = "Search is complete<br> Space complexity-O(1)";
    currentState["lineNo"] = 0;
    stateList.push(currentState);
  ...
  this.findMin = function () {
    ...
    while (currentVertex != null) {
      ...
      if (internalBst[currentVertex]["leftChild"] != null) {
        currentState["status"] =
          currentVertex + " is not the minimum value as it has a left child.";
        currentState["lineNo"] = 2;
      } else {
        ans = currentVertex;
    ...
    currentState = createState(internalBst);
    currentState["status"] =
      "Find Min has ended. The minimum value is " +
      ans +
      "." +
  ...
  this.findMax = function () {
    ...
    while (currentVertex != null) {
      ...
      if (internalBst[currentVertex]["rightChild"] != null) {
        currentState["status"] =
          currentVertex + " is not the maximum value as it has a right child.";
        currentState["lineNo"] = 2;
      } else {
        ans = currentVertex;
    ...
    currentState = createState(internalBst);
    currentState["status"] =
      "Find Max has ended. The maximum value is " +
      ans +
      "." +
      ",<br>Space complexity-O(n)";
    currentState["lineNo"] = 0;
  ...
  this.findSuccessor = function (vertexText) {
    ...
    if (internalBst[vertexText] == null) {
      $("#successor-err").html(
        "Please fill in a value present inside the BST!"
      );
      return false;
    }
    ...
    if (internalBst[vertexText]["rightChild"] != null) {
      ...
      var rightChildVertexClass =
        internalBst[rightChildVertex]["vertexClassNumber"];
      ...
      if (internalBst[rightChildVertex]["leftChild"] != null) {
        ...
        while (internalBst[currentVertex]["leftChild"] != null) {
          ...
          currentState["status"] =
            currentVertex +
            " is not the successor vertex as it has a left child.";
          currentState["lineNo"] = 0;
        ...
        currentState["vl"][rightChildVertexClass]["state"] = VERTEX_HIGHLIGHTED;
        currentState["status"] =
          "No left child found, so this vertex is the successor.";
        currentState["lineNo"] = 0;
        stateList.push(currentState);
      }
    } else {
      ...
      while (true) {
        ...
        if (currentVertex < vertexText) {
          currentState["status"] =
            currentVertex +
            " is not the successor vertex as " +
            vertexText +
            " is part of the right sub-tree";
          currentState["lineNo"] = 0;
          stateList.push(currentState);
        } else {
          ans = currentVertex;
    ...
    if (ans != null)
      currentState["status"] =
        "Find successor has ended. The successor of " +
        vertexText +
        " is " +
        ans +
        ".";
      ...
      currentState["status"] =
        "Find successor has ended. " + vertexText + " has no successor.";
    currentState["lineNo"] = 0;
    stateList.push(currentState);
  ...
  this.inorderTraversal = function () {
    ...
    currentState = createState(internalBst);
    currentState["status"] =
      "In-order traversal of the whole BST is complete.<br> Space complexity-O(n)O(n)O(n)";
    currentState["lineNo"] = 0;
    stateList.push(currentState);
  ...
  this.insertArr = function (vertexTextArr) {
    ...
    for (i = 0; i < vertexTextArr.length; i++) {
      ...
      if (heightCounter > maxHeightAllowed) {
        $("#insert-err").html(
          "Sorry, this visualization can only support tree of maximum height " +
            maxHeightAllowed
        );
        return false;
      }
    ...
    for (i = 0; i < vertexTextArr.length; i++) {
      ...
      while (currentVertex != vertexText && currentVertex != null) {
        ...
        currentState["status"] =
          "Comparing " + vertexText + " with " + currentVertex;
        if (!isAVL) {
          currentState["lineNo"] = 3;
        } else {
          currentState["lineNo"] = 1;
        ...
        if (
          parseInt(vertexText) > parseInt(internalBst[currentVertex]["parent"])
        ) {
          currentState["status"] =
            vertexText +
            " is larger than " +
            internalBst[currentVertex]["parent"] +
            ", so go right.";
          if (!isAVL) {
            currentState["lineNo"] = 5;
          } else {
      ...
      // Then, draw edge
      var newNodeVertexClass =
        internalBst[parseInt(vertexText)]["vertexClassNumber"];
      ...
      if (currentVertex != null) {
        ...
        currentState["status"] =
          "Location found! Inserting " + vertexText + " ...";
        currentState["lineNo"] = 1;
      ...
      // End State
      currentState = createState(internalBst);
      currentState["status"] = "Insert " + vertexText + " has been completed. <br> Space complexity-O(n)";
      if (isAVL) {
        currentState["lineNo"] = 1;
      }
      stateList.push(currentState);
      ...
      if (isAVL) {
        ...
        while (vertexCheckBf != null) {
          var vertexCheckBfClass =
            internalBst[vertexCheckBf]["vertexClassNumber"];
          ...
          currentState["status"] =
            "Balance factor of " + vertexCheckBf + " is " + bf + ".";
          currentState["lineNo"] = 2;
          stateList.push(currentState);

          if (bf == 2) {
            var vertexCheckBfLeft = internalBst[vertexCheckBf]["leftChild"];
            var vertexCheckBfLeftClass =
              internalBst[vertexCheckBfLeft]["vertexClassNumber"];
            var bfLeft = internalBst[vertexCheckBfLeft]["balanceFactor"];

            currentState = createState(internalBst);
            currentState["vl"][vertexCheckBfClass]["state"] =
              VERTEX_HIGHLIGHTED;
            currentState["vl"][vertexCheckBfLeftClass]["state"] =
              VERTEX_HIGHLIGHTED;
            currentState["status"] =
              "And balance factor of " +
              vertexCheckBfLeft +
              " is " +
              bfLeft +
              ".";
            ...
            if (bfLeft == 1 || bfLeft == 0) {
              ...
              currentState["vl"][vertexCheckBfLeftClass]["state"] =
                VERTEX_HIGHLIGHTED;
              currentState["el"][vertexCheckBfClass]["state"] =
                EDGE_HIGHLIGHTED;
              if (internalBst["root"] != vertexCheckBfLeft)
                currentState["el"][vertexCheckBfLeftClass]["state"] =
                  EDGE_HIGHLIGHTED;
              ...
              var vertexCheckBfLeftRight =
                internalBst[vertexCheckBfLeft]["rightChild"];
              var vertexCheckBfLeftRightClass =
                internalBst[vertexCheckBfLeftRight]["vertexClassNumber"];
              ...
              currentState["vl"][vertexCheckBfLeftClass]["state"] =
                VERTEX_HIGHLIGHTED;
              currentState["vl"][vertexCheckBfLeftRightClass]["state"] =
                VERTEX_HIGHLIGHTED;
              currentState["el"][vertexCheckBfLeftClass]["state"] =
                EDGE_HIGHLIGHTED;
              currentState["el"][vertexCheckBfLeftRightClass]["state"] =
                EDGE_HIGHLIGHTED;
            ...
            var vertexCheckBfRightClass =
              internalBst[vertexCheckBfRight]["vertexClassNumber"];
            var bfRight = internalBst[vertexCheckBfRight]["balanceFactor"];

            currentState = createState(internalBst);
            currentState["vl"][vertexCheckBfClass]["state"] =
              VERTEX_HIGHLIGHTED;
            currentState["vl"][vertexCheckBfRightClass]["state"] =
              VERTEX_HIGHLIGHTED;
            currentState["status"] =
              "And balance factor of " +
              vertexCheckBfRight +
            ...
            if (bfRight == 1) {
              var vertexCheckBfRightLeft =
                internalBst[vertexCheckBfRight]["leftChild"];
              var vertexCheckBfRightLeftClass =
                internalBst[vertexCheckBfRightLeft]["vertexClassNumber"];
              ...
              currentState["vl"][vertexCheckBfRightClass]["state"] =
                VERTEX_HIGHLIGHTED;
              currentState["vl"][vertexCheckBfRightLeftClass]["state"] =
                VERTEX_HIGHLIGHTED;
              currentState["el"][vertexCheckBfRightClass]["state"] =
                EDGE_HIGHLIGHTED;
              currentState["el"][vertexCheckBfRightLeftClass]["state"] =
                EDGE_HIGHLIGHTED;
              currentState["status"] =
                "Rotate right " + vertexCheckBfRight + ".";
              currentState["lineNo"] = 6;
              stateList.push(currentState);
        ...
        currentState = createState(internalBst);
        currentState["status"] =
          "The tree is now balanced.<br> Space complexity-O(n)";
        currentState["lineNo"] = 7;
        stateList.push(currentState);
      }
    }
  ...
  this.removeArr = function (vertexTextArr) {
    ...
    for (i = 0; i < vertexTextArr.length; i++) {
      ...
      while (currentVertex != vertexText && currentVertex != null) {
        ...
        currentState["status"] =
          "Searching for node " + vertexText + " to remove";
        currentState["lineNo"] = 1;
        stateList.push(currentState);
      ...
      if (
        internalBst[currentVertex]["leftChild"] == null &&
        internalBst[currentVertex]["rightChild"] == null
      ) {
        currentState = createState(internalBst, vertexTraversed, edgeTraversed);
        currentState["status"] =
          "Node " + vertexText + " has no children. It is a leaf.";
        if (!isAVL) {
          currentState["lineNo"] = 2;
        } else {
          currentState["lineNo"] = 1;
      ...
      // Only right child
        ...
        currentState = createState(internalBst, vertexTraversed, edgeTraversed);
        currentState["status"] =
          "Node " + vertexText + " has a right child only";
        if (!isAVL) {
          currentState["lineNo"] = 4;
        } else {
          currentState["lineNo"] = 1;
        ...
        currentState["status"] =
          "Delete node " +
          vertexText +
          " and connect its parent to its right child";
        if (!isAVL) {
          currentState["lineNo"] = 5;
        } else {
          currentState["lineNo"] = 1;
      ...
      // Only left child
        ...
        currentState = createState(internalBst, vertexTraversed, edgeTraversed);
        currentState["status"] =
          "Node " + vertexText + " has a left child only";
        if (!isAVL) {
          currentState["lineNo"] = 4;
        } else {
          currentState["lineNo"] = 1;
        ...
        currentVertexClass = internalBst[currentVertex]["vertexClassNumber"];
        leftChildVertexClass =
          internalBst[leftChildVertex]["vertexClassNumber"];
        delete internalBst[currentVertex];
        delete vertexTraversed[currentVertex];
        delete edgeTraversed[currentVertexClass];
        ...
        currentState["status"] =
          "Delete node " +
          vertexText +
          " and connect its parent to its left child";
        if (!isAVL) {
          currentState["lineNo"] = 5;
        } else {
          currentState["lineNo"] = 1;
      ...
      // Case 3: two children
        ...
        var successorVertexClass =
          internalBst[successorVertex]["vertexClassNumber"];
        ...
        while (internalBst[successorVertex]["leftChild"] != null) {
          ...
          currentState["vl"][currentVertexClass]["state"] = VERTEX_HIGHLIGHTED;
          currentState["vl"][successorVertexClass]["state"] =
            VERTEX_HIGHLIGHTED;
        ...
        var successorRightChildVertex =
          internalBst[successorVertex]["rightChild"];
        ...
        if (successorVertex != rightChildVertex) {
          ...
          if (successorRightChildVertex != null) {
            if (parseInt(successorParentVertex) < parseInt(successorVertex))
              internalBst[successorParentVertex]["rightChild"] =
                successorRightChildVertex;
            else
              internalBst[successorParentVertex]["leftChild"] =
                successorRightChildVertex;

            internalBst[successorRightChildVertex]["parent"] =
        ...
        if (successorVertex != rightChildVertex) {
          ...
          if (successorRightChildVertex != null) {
            var successorRightChildVertexClass =
              internalBst[successorRightChildVertex]["vertexClassNumber"];
            currentState["el"][successorRightChildVertexClass]["state"] =
              EDGE_HIGHLIGHTED;
          }
        }

        currentState["status"] =
          "Replace node " + vertexText + " with its successor";
        if (!isAVL) {
          currentState["lineNo"] = 6;
        } else {
          currentState["lineNo"] = 1;
      ...
      currentState = createState(internalBst);
      currentState["status"] = "Removal of " + vertexText + " completed <br> Space Complexity:O(log n)";
      if (!isAVL) {
        currentState["lineNo"] = 0;
      } else {
        currentState["lineNo"] = 1;
      ...
      if (isAVL) {
        ...
        currentState = createState(internalBst);
        currentState["status"] =
          "The tree is now balanced.<br> Space complexity-O(n)O(n)O(n)";
        currentState["lineNo"] = 7;
        stateList.push(currentState);
      }
    }
  ...
  function recalculateBalanceFactor() {
    ...
    function balanceFactorRecursion(vertexText) {
      ...
      var balanceFactorHeightLeft = balanceFactorRecursion(
        internalBst[vertexText]["leftChild"]
      );
      var balanceFactorHeightRight = balanceFactorRecursion(
        internalBst[vertexText]["rightChild"]
      );

      internalBst[vertexText]["balanceFactorHeight"] =
        Math.max(balanceFactorHeightLeft, balanceFactorHeightRight) + 1;
      internalBst[vertexText]["balanceFactor"] =
