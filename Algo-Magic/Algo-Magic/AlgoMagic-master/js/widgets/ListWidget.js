...
var List = function () {
  ...
  this.peek = function () {
    ...
    currentState["status"] = "Peek is complete,<br>Space complexity-O(n)";
  ...
  this.search = function (vertexText) {
    ...
    currentState = createState(internalList);
    currentState["status"] = "Search is complete <br>Space complexity-O(n)";
    currentState["lineNo"] = 0;
    stateList.push(currentState);
  ...
  this.insertArrKth = function (vertexTextArr, index) {
    ...
    currentState = createState(internalList);
    currentState["status"] =
      "Insert " + vertexText + " has been completed. <br>Space complexity-O(1)";
    currentState["lineNo"] = 0;
    stateList.push(currentState);
  ...
  this.insertArrKthDoublyList = function (vertexTextArr, index) {
    ...
    currentState["el"][currentVertexClass]["state"] = EDGE_TRAVERSED;
    currentState["el"][newVertexVertexClass]["state"] = EDGE_RED;
    currentState["el"][newVertexVertexClass + BACK_EDGE_CONST]["state"] =
      OBJ_HIDDEN;
    currentState["status"] = "newVertex.next points to temp2";
    currentState["lineNo"] = 6;
    stateList.push(currentState);
    ...
    currentState["el"][newVertexVertexClass + BACK_EDGE_CONST]["state"] =
      EDGE_GREEN;
    currentState["el"][currentVertexClass + BACK_EDGE_CONST]["state"] =
      OBJ_HIDDEN;
    ...
    currentState["status"] =
      ...
      vertexText +
      " has been inserted!<br>Space complexity-O(1)";
    currentState["lineNo"] = 0;
  ...
  this.insertArrHead = function (vertexTextArr) {
    ...
    currentState = createState(internalList, vertexTraversed, edgeTraversed);
    currentState["status"] =
      vertexText + " has been inserted!  <br>Space complexity-O(1)";
    currentState["lineNo"] = 0;
    stateList.push(currentState);
  ...
  this.insertArrTail = function (vertexTextArr) {
    ...
    currentState["status"] =
      "Insert " +
      vertexText +
      " to tail has been completed.<br>Space complexity-O(1)";
    currentState["lineNo"] = 0;
    stateList.push(currentState);
  ...
  this.insertArrTailDoublyList = function (vertexTextArr) {
    ...
    currentState["status"] =
      "Insert " +
      vertexText +
      " to tail has been completed.<br> Space Complexity-O(n)";
    currentState["lineNo"] = 0;
    stateList.push(currentState);
  ...
  this.removeArrHead = function () {
    ...
    if (internalList[currentVertex]["rightChild"] == null) {
      ...
      currentState = createState(internalList, vertexTraversed, edgeTraversed);
      currentState["status"] = "Remove first vertex<br>Space complexity-O(1)";
      currentState["lineNo"] = 3;
      stateList.push(currentState);
    ...
    currentState = createState(internalList);
    currentState["status"] =
      "Removal of first vertex completed<br>Space complexity-O(1)";
    currentState["lineNo"] = 0;
    stateList.push(currentState);
  ...
  this.removeArrTail = function () {
    ...
    currentState = createState(internalList);
    currentState["status"] =
      "Removal of last vertex completed,<br>Space complexity-O(1)";
    currentState["lineNo"] = 0;
    stateList.push(currentState);
  ...
  this.removeArrKth = function (vertexTextArr) {
    ...
    currentState = createState(internalList);
    currentState["status"] = "Removal completed <br> Space Complexity-O(1)";
    currentState["lineNo"] = 0;
  ...
  this.removeArrKthDoublyList = function (vertexTextArr) {
    ...
    if (internalList[currentVertex]["rightChild"] == null) {
      ...
      currentState["el"][parentVertexClass + BACK_EDGE_CONST]["state"] =
        OBJ_HIDDEN;
      currentState["vl"][rightChildVertexClass]["state"] = VERTEX_RED_FILL;
      currentState["status"] = "Delete vertex";
      currentState["lineNo"] = 6;
